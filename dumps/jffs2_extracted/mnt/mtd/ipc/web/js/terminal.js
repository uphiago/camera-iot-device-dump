...
function load_form_light()
{
	var f1 = document.getElementById("form_len1");
	var f0 = document.getElementById("form_len0");
...
function submit_form_light()
{
	var f = document.getElementById("form_len1");
	var s = document.getElementById("form_submit");
	
	if (f.checked == true)
		s.light_enable.value = "on";
	else
		s.light_enable.value = "off";
