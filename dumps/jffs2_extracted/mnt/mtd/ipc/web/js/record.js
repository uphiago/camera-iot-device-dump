...
function check_form_timerec()
{
	...
	if ((f.value < 15) || (f.value >600))
	{
		alert(str_err_recfile1);
		f.select();
		return false;
	}
...
function load_form_planrectype()
{
        var f = document.getElementById("form_recformat");
...
function submit_form_planrectype()
{
    var f = document.getElementById("form_recformat");
    var s = document.getElementById("form_submit");
    s.planrec_type.value = f.value;
