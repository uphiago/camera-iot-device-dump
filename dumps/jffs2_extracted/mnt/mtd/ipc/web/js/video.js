...
function load_form_bps1()
{
	var f = document.getElementById("form_bps1");
        ...
        var o = document.getElementById("form_bps1dc");
...
{
	var f = document.getElementById("form_size1d");
       ...
       if(strmode=="k")
	{
           if (f.selectedIndex == 0)
	  {
		...
		return false;
            ...
            {
		if ((o.value<32) || (o.value > 512))
	       {
		alert(str_note_maxbps3);
		o.select();
		return false;
	       }
             }
